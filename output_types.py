...
class QuestionAnalysis(BaseModel):
  ...
  query_type: str = Field(description="GENERAL | COMPLEX | TRADING | SKILL | ENGRAVING | AVATAR | ARK_GRID | ARK_PASSIVE | COLLECTIBLE | PROFILE | TOTAL_INFO | EXPEDITION | MARKET_ITEMS | AUCTION_ITEMS 중 하나")
